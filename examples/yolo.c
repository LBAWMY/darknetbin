...
char *voc_names[] = {"wangzulan", "angelababy", "chenhe", "lichen", "dengchao", "dilireba", "zhengkai", "luhan"};
...
void test_yolo(char *cfgfile, char *weightfile, char *filename, float thresh)
{
    ...
    while(1){
        ...
        draw_detections(im, l.side*l.side*l.n, thresh, boxes, probs, voc_names, alphabet, 8);
